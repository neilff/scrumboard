...
export const SEND_SOCKET = '@@rangleScrumblr/SEND_SOCKET';
...
export const SHOW_ROOM_USERS = '@@rangleScrumblr/SHOW_ROOM_USERS';
export const HIDE_ROOM_USERS = '@@rangleScrumblr/HIDE_ROOM_USERS';
...
export const HIDE_MENUS = '@@rangleScrumblr/HIDE_MENUS';
